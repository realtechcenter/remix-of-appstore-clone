...
import { Plus, Trash2, Users, Search, Tag, Percent, DollarSign, Calendar, X, Check } from 'lucide-react';
    ...
    <div className="space-y-6">
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {coupon.discount_type === 'fixed' ? (
                      <Badge variant="outline" className="gap-1">
                        ...
                        {parseFloat(String(coupon.discount_value)).toFixed(2)} off
                      </Badge>
                    ) : (
                      <Badge variant="outline" className="gap-1">
                  ...
                  <div className="flex items-center gap-4 mt-2 text-xs text-muted-foreground">
                    {coupon.min_price > 0 && (
                      <span>Min: ${parseFloat(String(coupon.min_price)).toFixed(2)}</span>
                    )}
                    {coupon.expires_at && (
                    ...
                    <span className="flex items-center gap-1">
                      ...
                      {coupon.user_coupons_count || 0} assigned / {coupon.used_count || 0} used
                    </span>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <Button 
                    variant="outline" 
                    size="sm"
                    onClick={() => openAssignDialog(coupon)}
                    className="gap-1"
                  >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="Get discount on your first purchase"
                className="mt-1"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  placeholder={formData.discount_type === 'fixed' ? '5.00' : '10'}
                  required
                  className="mt-1"
                />
              </div>
      ...
      <Dialog open={showAssignDialog} onOpenChange={setShowAssignDialog}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle>
              Assign Coupon: {selectedCoupon?.code}
            </DialogTitle>
          </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            {selectedUserIds.length > 0 && (
              <Button onClick={handleAssignUsers} className="w-full gap-2">
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Button
                            ...
                            onClick={() => handleRemoveUserCoupon(uc.user_id)}
                          >
                            <X className="w-4 h-4" />
                          </Button>
                        </div>
